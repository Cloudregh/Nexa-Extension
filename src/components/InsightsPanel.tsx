...
export const InsightsPanel = () => {
  ...
  return (
    <div className="w-[420px] flex-shrink-0 shrink-0 flex flex-col min-h-0 bg-[#F8F9FB] m-6 ml-0 rounded-[24px] border border-slate-200/60 overflow-hidden relative z-10">
      ...
      <div className="flex-1 overflow-y-auto px-8 py-2 space-y-10 pb-32">
